...
class ViewAFDBookingController extends Controller
{
                        ...
                        public function show($id) {
                           ...
                           // $users = DB::select('select * from agridbookings where BookingId = ?',[$id]);
                            ...
                            public function vcapprove(Request $request,$BookingId) {
                                ...
                                public function SendHodAMA(Request $request,$BookingId) {
                                    $data = $BookingId;
                                    $Status = 'Request HOD agribussiness Mnagment  Approval';
                                    ...
                                    $email = DB::select('select email from users where roleNo = -1');
    ...
    public function viewagribusinesshoddbooking(Request $request) {
